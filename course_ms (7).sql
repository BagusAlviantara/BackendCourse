...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2022 at 05:46 PM
...
(12, 'Data Administrator', '2022-09-29 08:14:13', '2022-09-29 08:14:13');
...
(7, 9, 2, '2022-09-29 07:59:48', '2022-09-29 07:59:48'),
(8, 12, 3, '2022-09-29 08:00:28', '2022-09-29 08:00:28'),
(9, 12, 4, '2022-09-29 08:00:28', '2022-09-29 08:00:28');
...
ALTER TABLE `student_reports`
  ...
  ADD CONSTRAINT `student_reports_ibfk_4` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
