...
(1, 1, 8, 'Yudi Utama', 'Jalan Noja II', 'Laki-Laki', '081246431155', '2022-08-16 03:08:37', '2022-08-16 03:08:37'),
(2, 4, 8, 'Dyah Kusuma', 'Jalan Gatot Subroto Timur', 'Perempuan', '082563790191', '2022-08-16 04:17:42', '2022-08-16 05:16:33'),
(3, 3, 8, 'Bagus Alviantara', 'Jalan Kenangan Indah', 'Laki-Laki', '082236608111', '2022-08-16 05:10:34', '2022-08-16 05:10:34');
...
(2, 9, 'Dwi Utama', '087233782901', 'Badung', 17, 'Male', '2022-09-07 02:30:08', '2022-09-07 02:30:08'),
...
CREATE TABLE `student_reports` (
  ...
  `student_product_id` int(5) NOT NULL,
  `schedule_id` int(5) NOT NULL,
...
(5, 'Wahyu Wastuguna', '081176228291', 'wahyu@gmail.com', '$argon2id$v=19$m=4096,t=3,p=1$FsqaEA+wb+mpObEaxPZU5Q$HpjKtQ6DzDOlf0/oCt0vFLrVYrdoj0Yr15G7ieng6Jo', 'Student', '2022-08-09 03:27:04', '2022-09-07 02:28:34'),
...
ALTER TABLE `student_reports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `student_reports_ibfk_2` (`student_product_id`),
...
ALTER TABLE `student_reports`
  ...
  ADD CONSTRAINT `student_reports_ibfk_3` FOREIGN KEY (`student_product_id`) REFERENCES `students` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
