...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2022 at 03:41 PM
...
INSERT INTO `class_schedule` (`id`, `employee_id`, `product_id`, `date`, `start_time`, `end_time`, `created_at`, `update_at`) VALUES
(7, 3, 1, '2022-09-01', '13:00:00', '16:00:00', '2022-09-01 03:49:45', '2022-09-01 04:13:01'),
(8, 4, 1, '2022-09-14', '13:00:00', '15:00:00', '2022-09-04 23:56:53', '2022-09-04 23:56:53');
...
(2, 4, 1, 'Dyah Kusuma', 'Jalan Gatot Subroto Timur', 'Perempuan', '082563790191', '2022-08-16 04:17:42', '2022-08-16 05:16:33'),
...
(1, 1, 2, 'Pertanyaan Pertama', 'Saya ingin bertanya ya', '1', '2022-09-21 07:00:58', '2022-09-22 01:09:08'),
(2, 1, 2, 'Pertanyaan', 'Saya ingin bertanya', '2', '2022-09-22 01:05:15', '2022-09-22 01:05:15');
...
ALTER TABLE `attendances`
  ...
  ADD CONSTRAINT `attendances_ibfk_2` FOREIGN KEY (`schedule_id`) REFERENCES `class_schedule` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
