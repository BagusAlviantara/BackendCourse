...
exports.createAttendance = async(req, res) => {
    ...
    const { id, user_id, status, student_id, schedule_id } = req.body;
    try {
...
exports.updateAttendance = async(req, res) => {
    try {
        ...
        const { user_id, status, student_id, schedule_id } = req.body;
        await Attendance.update({ user_id, status, student_id, schedule_id }, {
            where: {
                id: Attendance.id
            }
        });
